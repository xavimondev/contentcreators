...
export const LoadingIc = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      className='w-5 h-5 text-gray-200 animate-spin dark:text-gray-500 fillWhite'
      viewBox='0 0 100 101'
      fill='none'
      xmlns='http://www.w3.org/2000/svg'
      {...props}
...
export const ShareIc = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg height='21' viewBox='0 0 21 21' width='21' xmlns='http://www.w3.org/2000/svg' {...props}>
      <g
        fill='none'
...
export const LeftArrowIc = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg viewBox='0 0 21 21' width='21' xmlns='http://www.w3.org/2000/svg' {...props}>
      <g
        fill='none'
        fillRule='evenodd'
        stroke='currentColor'
...
export const TrashIc = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      viewBox='0 0 24 24'
      strokeWidth='1.8'
...
export const PencilIc = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      viewBox='0 0 24 24'
      strokeWidth='1.8'
...
export const SaveIc = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      strokeWidth='1.8'
      viewBox='0 0 24 24'
...
export const CancelIc = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      fill='currentColor'
